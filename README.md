...
## 9. 5-Minute Reviewer Demo Guide

Follow these steps to demonstrate every requirement in under 5 minutes:
...
6. **Cancellation & Automatic FIFO Waitlist Reallocation**:
   ...
   - Notice the notice: the seat is automatically reallocated to Customer 2!
